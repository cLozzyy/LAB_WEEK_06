...
// Remove imageLoader from the constructor, as it's no longer needed.
class CatAdapter(private val layoutInflater: LayoutInflater) : RecyclerView.Adapter<CatViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CatViewHolder {
        ...
        // Remove imageLoader from the constructor call.
